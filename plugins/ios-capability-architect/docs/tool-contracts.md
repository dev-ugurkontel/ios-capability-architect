...
| `check_availability`                 | IDs            | platform, OS, device, region, language, beta flag                             | numeric platform/OS result plus explicit manual checks for free-text device, region, and language constraints | Unknown capability error                         |

...
The submission contains no hosted service, authentication, telemetry, or external data storage. It includes 18 reviewed capability profiles, a 193-entry discovery catalog with explicit coverage status, official-source metadata, conservative unknown handling, and positive and negative reviewer fixtures.

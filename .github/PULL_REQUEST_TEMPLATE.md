...
Describe the problem, the chosen solution, and the user-visible outcome.

## Change type

- [ ] Bug fix
- [ ] Feature or tool behavior
- [ ] Verified capability data
- [ ] Documentation
- [ ] Build, test, or maintenance
- [ ] Breaking contract or schema change
...
Call out the highest-risk decision, unresolved limitation, and the part of the change that most needs independent verification.
